...
import {BASE_ROUTE, LOGIN_ROUTE, SIGNUP_ROUTE, SEARCH_PAPER_LIST_ROUTE, MY_PAPER_LIST_ROUTE} from './constants';
...
const routes = (
    <Switch>
        ...
        <Route exact path={MY_PAPER_LIST_ROUTE} component={MyPapersContainer}/>
